...
#### JavaScript
1. 《[JS函数式编程](https://github.com/DrBoolean/mostly-adequate-guide)》
  - 今天看了[berwin：谈谈我对函数式编程的思考](https://github.com/berwin/Blog/issues/15) 博客，才记起来此书我并没有完全看完，现在重新想想，其实函数式编程离开发并不远，就和闭包一样（360企业安全1面问到了：闭包在开发中用得多么？我回答的是，直接写闭包的不多，多数是放在底层实现了），其实每时每刻都在用，只是没有那么刻意的在业务中直接写一个闭包。
...
1. 《Javascript DOM编程艺术第二版（2011.4）》 *2018.5.14*
...
1. 《深入React技术栈（2016-11）》
1. 《深入浅出React和Redux（2017-04）》
...
1. 《JavaScript 忍者秘籍 (2015.10)》*2018.4.1完成部分*
  - 2 自我实现一个非常简单的单元测试函数
